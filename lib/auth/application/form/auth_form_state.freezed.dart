...
abstract class $AuthFormStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Username username, Password password, bool showErrors});
}
...
class _$_AuthFormState implements _AuthFormState {
  ...
  @override
  String toString() {
    return 'AuthFormState(username: $username, password: $password, showErrors: $showErrors)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, username, password, showErrors);
